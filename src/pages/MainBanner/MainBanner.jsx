    ...
    <div>
      <header className='global-header'>
        <div className='gnb'>
          ...
          <div className='logo'>
            <a href="/">
              <img className='logoImg' src="/img/logo.png" alt="대전시청 로고" />
            </a>
          </div>
          ...
          <div className='searchWrapper'>
            <div className="searchBox">
              <form action="https://www.google.com/search" method="GET">
                <input name="q" type="text" placeholder='검색하시면 Goggle페이지로 이동합니다.' />
              </form>
            </div>
            <img className='searchImg' src='/icon/search-icon.png' alt='검색 아이콘'></img>
