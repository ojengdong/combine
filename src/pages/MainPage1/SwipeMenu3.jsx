      ...
      <div>
        <div className='wrapper'>
          <div className="front-text-btn">
            <h1 className='menu-setting-text'>내가 만드는 자주 가는 서비스, 바로 설정해보세요.</h1>
          ...
          <div className='menu-box'>
            <div className="menu-box1" style={style2}>
              <div style={style} className="menu-box2">
                <div className='menu-img-box'>
                  <img className='menu-img' src="./icon/service (21).png" alt="행정예산제정" />
                </div>
                <div className='menu-img-box'>
                  <img className='menu-img' src="./icon/service (2).png" alt="문화관광체육" />
                </div>
                <div className='menu-img-box'>
                  <img className='menu-img' src="./icon/service (4).png" alt="생생뉴스/민원" />
                </div>
                <div className='menu-img-box'>
                  <img className='menu-img' src="./icon/service (3).png" alt="보건복지환경" />
                </div>
                <div className='menu-img-box'>
                  <img className='menu-img' src="./icon/service (5).png" alt="시민참여" />
                </div>
                <div className='menu-img-box'>
                  <img className='menu-img' src="./icon/service (21).png" alt="행정예산제정" />
                </div>
            ...
            <div className="setting-wrapper">
              <div className='setting-box'>
                <div className='setting'><img onClick={setting} src="./icon/setting-icon.png" alt="" /></div>
              </div>
            ...
            <div className="menu-box1" style={style2}>
              <div style={style} className="menu-box2">
                {saveChecked.map((item, i) => (
                  <div className="menu-img-box"><img key={i} className='menu-img' src={`./icon/service (${item}).png`} alt="" /></div>
                ))}
              </div>
            </div>
            <div className="setting-wrapper">
