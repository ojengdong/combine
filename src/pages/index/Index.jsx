    ...
    return (
        ...
        <div className='index-wrapper'>
                ...
                <div className='index-Box'>
                    <div className='index-BoxList'>
                     ...
                     <Link to="/Mainpage">    
                        <div className="index-Boxtem">
                            <div className="index-bottom-imgbox"><img className='index-bottom-img1' src='/img/일류경제도시 슬로건-01.png' alt="일류경제도시 슬로건" /></div>
                    ...
                    <div className='index-BoxList'>
                      <Link to ="/GesifanJunche">
                        <div className="index-Boxtem">
                            <div className="index-bottom-imgbox"><img className='index-bottom-img2' src='/img/위에서 보는 사람들-01.png' alt="민원게시판 일러스트" /></div>
            ...
            <div className='index-footer'>
                <img className='index-footer-img' src='/img/대전 슬로건.png' alt="daejeon 슬로건" />
