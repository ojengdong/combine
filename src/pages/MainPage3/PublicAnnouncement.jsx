      ...
      <div className='PublicAnnouncement-wrapper'>
          <div className='PublicAnnouncement-Box'>
            ...
            <div className='PublicAnnouncement-menuright'>
              <button>
                  <img src="/icon/btn-left.png" alt="left" />
              </button>
              <button>
                  <img src="/icon/btn-right.png" alt="right" />
              </button>
              <div className='PublicAnnouncement-moreBtn'><button> + 더보기</button></div>
            </div>
          </div>
          ...
          >
            <SwiperSlide>
              <div className='PublicAnnouncement-box1'>
                <div className='PublicAnnouncement-box-inner'>
                  <p className='PublicAnnouncement-span'>2023 시민정원사 양성 초급과정 <br></br>모집완료</p>
                  <p>2023-03-27</p>
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className='PublicAnnouncement-box1'>
                <div className='PublicAnnouncement-box-inner'>
                  <p className='PublicAnnouncement-span'>미세먼지(PM-10) 주의보 발령 해제<br></br>(대전 전지역)</p>
                  <p>2023-03-27</p>
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className='PublicAnnouncement-box1'>
                <div className='PublicAnnouncement-box-inner'>
                  <p className='PublicAnnouncement-span'>2023년 청년도전 지원사업<br></br>참여자 모집</p>
                  <p>2023-03-27</p>
                </div>
              </div>
            </SwiperSlide>
