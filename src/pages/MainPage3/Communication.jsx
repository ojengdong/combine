        ...
        <div className='Communication-wrapper-inner'>
          ...
          <div className='Communication-Swiper-Box'>
            ...
            >
              ...
              <SwiperSlide>
                <img src="/img/자동차 탄소중립포인트.jpg" alt="자동차 탄소중립 포인트 배너" />
              </SwiperSlide>
              <SwiperSlide>
                <img src="/img/정부풀연연구기관.jpg" alt="정부풀연 연구기관 배너" />
              </SwiperSlide>
            </Swiper>
          </div>
        </div>
