                          ...
                          <div className='mayor-box'>
                              <div className="mayor-list">
                                  ...
                                  <div className='mayor-arrow'>
                                      <img style={{ width: 40 }} src='/mayorBox/mayor-arrow.png' alt="대전시장 이장우 바로가기 화살표" />
                                  </div>
                                  <div className='mayor-titleimg'>
                                      <img style={{ width: 70 }} src='/mayorBox/mayor-1.png' alt="대전시장 이장우 일러스트" />
                                  </div>
                              </div>
                          </div>
                      </div>
                      ...
                      <div className="mayorBox-wrapper">
                          <div className='mayor-box'>
                              <div className="mayor-list">
                                  <p>{mayorTitle[1]}</p>
                                  <div className='mayor-arrow'>
                                      <img style={{ width: 40 }} src='/mayorBox/mayor-arrow.png' alt="이장우의 공약사업 바로가기 화살표" />
                                  </div>
                                  <div className='mayor-titleimg'>
                                      <img style={{ width: 70 }} src='/mayorBox/mayor-2.png' alt="이장우의 공약사업 일러스트" />
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div className="mayorBox-wrapper">
                          <div className='mayor-box'>
                              <div className="mayor-list">
                                  <p>{mayorTitle[2]}</p>
                                  <div className='mayor-arrow'>
                                      <img style={{ width: 40 }} src='/mayorBox/mayor-arrow.png' alt="소통하는 이장우 바로가기 화살표" />
                                  </div>
                                  <div className='mayor-titleimg'>
                                      <img style={{ width: 70 }} src='/mayorBox/mayor-3.png' alt="소통하는 이장우 일러스트" />
                                  </div>
                              </div>
                          </div>
                      </div>
